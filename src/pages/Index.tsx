...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-[#FF3B13] selection:text-white overflow-x-hidden">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 sm:px-12 pt-8 sm:pt-16 font-mono">
        {/* ── Hero Section ────────────────────────────────────────────── */}
        <section className="relative pb-20 pt-16">
          ...
          <div className="flex flex-col items-center text-center relative z-40">
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <h1 className="text-black max-w-[1000px] flex flex-col items-center tracking-tighter leading-[0.8] font-black uppercase">
            ...
            <div className="relative z-[60] mt-12 mb-12">
              <button 
                onClick={toggleAuth}
            ...
            <div className="relative">
              ...
              <motion.p 
                animate={{ opacity: isAuthVisible ? 0 : 0.4, y: isAuthVisible ? 20 : 0 }}
                className="mt-8 sm:mt-16 max-w-lg mx-auto text-[10px] sm:text-xs text-black font-bold px-4 leading-loose tracking-[0.2em] uppercase"
              >
      ...
      {/* ── Footer ────────────────────────────────────────────────── */}
      <footer className="relative z-10 mx-auto max-w-7xl px-6 sm:px-12 py-24 border-t border-black/5 flex flex-col sm:flex-row items-center justify-between gap-12 text-black/40">
