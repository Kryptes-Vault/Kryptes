...
- [Google OAuth via Supabase](./google-oauth-supabase.md)
- [Environment cleanup and security](../platform/env-cleanup-security.md)
- [Send Email HTTPS hook](./email-auth-hook.md)
- [Custom SMTP integration](./custom-smtp.md)
- [Architecture update (Firebase to Supabase)](../platform/supabase-migration-firebase.md)
- [Environment variable template](../platform/env-template.md)
- [Documentation index](../README.md)
- [Post-deploy checklist](../operations/checklists/post-deploy.md)
- [Supabase dashboard checklist](../operations/checklists/supabase-dashboard.md)
- [Ephemeral sharing (burn-on-read)](../encryption/ephemeral-sharing.md)
